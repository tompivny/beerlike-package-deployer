...
namespace BeerLike.PackageDeployer.Models.Dataverse
{
	...
	public partial class FieldSecurityProfile : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<BeerLike.PackageDeployer.Models.Dataverse.Team> teamprofiles_association
		{
			get
			{
				return this.GetRelatedEntities<BeerLike.PackageDeployer.Models.Dataverse.Team>("teamprofiles_association", null);
			}
			set
			{
				this.OnPropertyChanging("teamprofiles_association");
				this.SetRelatedEntities<BeerLike.PackageDeployer.Models.Dataverse.Team>("teamprofiles_association", null, value);
