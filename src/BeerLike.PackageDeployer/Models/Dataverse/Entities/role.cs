...
namespace BeerLike.PackageDeployer.Models.Dataverse
{
	...
	public partial class Role : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<BeerLike.PackageDeployer.Models.Dataverse.Role> Referencedrole_parent_role
		{
			get
			{
				return this.GetRelatedEntities<BeerLike.PackageDeployer.Models.Dataverse.Role>("role_parent_role", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedrole_parent_role");
				this.SetRelatedEntities<BeerLike.PackageDeployer.Models.Dataverse.Role>("role_parent_role", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<BeerLike.PackageDeployer.Models.Dataverse.Role> Referencedrole_parent_root_role
		{
			get
			{
				return this.GetRelatedEntities<BeerLike.PackageDeployer.Models.Dataverse.Role>("role_parent_root_role", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedrole_parent_root_role");
				this.SetRelatedEntities<BeerLike.PackageDeployer.Models.Dataverse.Role>("role_parent_root_role", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public BeerLike.PackageDeployer.Models.Dataverse.Role Referencingrole_parent_role
		{
			get
			{
				return this.GetRelatedEntity<BeerLike.PackageDeployer.Models.Dataverse.Role>("role_parent_role", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
		...
		public BeerLike.PackageDeployer.Models.Dataverse.Role Referencingrole_parent_root_role
		{
			get
			{
				return this.GetRelatedEntity<BeerLike.PackageDeployer.Models.Dataverse.Role>("role_parent_root_role", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
	}
}
