...
namespace BeerLike.PDX.Models
{
	...
	public partial class Team : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<BeerLike.PDX.Models.FieldSecurityProfile> teamprofiles_association
		{
			get
			{
				return this.GetRelatedEntities<BeerLike.PDX.Models.FieldSecurityProfile>("teamprofiles_association", null);
			}
			set
			{
				this.OnPropertyChanging("teamprofiles_association");
				this.SetRelatedEntities<BeerLike.PDX.Models.FieldSecurityProfile>("teamprofiles_association", null, value);
		...
		public System.Collections.Generic.IEnumerable<BeerLike.PDX.Models.Role> teamroles_association
		{
			get
			{
				return this.GetRelatedEntities<BeerLike.PDX.Models.Role>("teamroles_association", null);
			}
			set
			{
				this.OnPropertyChanging("teamroles_association");
				this.SetRelatedEntities<BeerLike.PDX.Models.Role>("teamroles_association", null, value);
