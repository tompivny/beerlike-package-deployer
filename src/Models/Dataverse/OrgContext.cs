...
namespace BeerLike.PDX.Models
{
	...
	public partial class OrgContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="BeerLike.PDX.Models.TeamProfiles"/> entities.
		/// </summary>
		public System.Linq.IQueryable<BeerLike.PDX.Models.TeamProfiles> TeamProfilesSet
		{
			get
			{
				return this.CreateQuery<BeerLike.PDX.Models.TeamProfiles>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="BeerLike.PDX.Models.TeamRoles"/> entities.
		/// </summary>
		public System.Linq.IQueryable<BeerLike.PDX.Models.TeamRoles> TeamRolesSet
		{
			get
			{
				return this.CreateQuery<BeerLike.PDX.Models.TeamRoles>();
			}
		}
	}
}
